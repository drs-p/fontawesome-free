...
\section{Usage}
The \textsf{\jobname} package contains all 2,058 icons from the free subset of the Font Awesome fonts. \DescribeMacro{\fa}The package provides one command, \cs{fa}, with a single mandatory argument: the \meta{name} of the icon. Some icons have light or ``open'' variants, like \fa{file-pdf-o} versus \fa{file-pdf}. Those variants are accessed by adding \texttt{-o} to the icon name: \verb|\fa{file-pdf-o}| versus \verb|\fa{file-pdf}|. A full list of icons and their names is included in the appendices.
