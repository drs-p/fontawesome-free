...
installing it in \texttt{\$TEXMFHOME} makes it available just for you.
...
\includepdf[pages=-, nup=3x1, landscape]{iconlist.pdf}

\newpage
\phantomsection
\addcontentsline{toc}{section}{Appendix B\quad List of brands}
\includepdf[pages=-, nup=3x1, landscape]{brandlist.pdf}
