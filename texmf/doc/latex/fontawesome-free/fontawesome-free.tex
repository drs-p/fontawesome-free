...
Some icons have light or ``open'' variants, like \fa{file-pdf-o} versus \fa{file-pdf}.
Those variants are accessed by adding \texttt{-o} to the icon name: \verb|\fa{file-pdf-o}| versus \verb|\fa{file-pdf}|.
...
\section{Copyright}
The Font Awesome fonts are Copyright 2024 Fonticons, Inc. (\url{https://fontawesome.com}) with Reserved Font Name: ``Font Awesome''.
...
\includepdf[pages=-, nup=4x1, landscape, offset={0mm 10mm}, alt={List of icons}]{iconlist.pdf}

\clearpage
\phantomsection
\addcontentsline{toc}{section}{B\quad List of brand icons}
\includepdf[pages=-, nup=4x1, landscape, offset={0mm 10mm}, alt={List of brand icons}]{brandlist.pdf}
